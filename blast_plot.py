...
df_of_Gmuris = pd.read_csv("output/blastn/G_intestinalis/G_muris.blastn", sep = "\t", header=None)
df_of_Ssalmonicida = pd.read_csv("output/blastn/G_intestinalis/S_salmonicida.blastn", sep = "\t", header=None)
